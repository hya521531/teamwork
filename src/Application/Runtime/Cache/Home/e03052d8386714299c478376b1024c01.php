            ...
            <div class="rightbox">
                ...
                <div class="cztable">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <?php if(is_array($chengji_list)): $i = 0; $__LIST__ = $chengji_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><?php echo ($vo["stu_num"]); ?></td>
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><?php echo ($vo["gaoshu"]); ?></td>
                            <td><?php echo ($vo["english"]); ?></td>
                            <td><?php echo ($vo["shujujiegou"]); ?></td>
                            <td><?php echo ($vo["shujuku"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
                        </tr>
                    </table>
                </div>
